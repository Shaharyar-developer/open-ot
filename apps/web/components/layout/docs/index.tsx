...
export function DocsLayout({
  nav: { transparentMode, ...nav } = { transparentMode: "always" },
  sidebar: {
    tabs: sidebarTabs,
  ...
  function sidebar() {
    ...
    const content = (
      <SidebarContent className="bg-background! border-0!" {...rest}>
        <SidebarHeader>
      ...
      <NavProvider transparentMode={transparentMode}>
        ...
        >
          ...
          {tabMode === "top" && tabs.length > 0 && (
            <LayoutTabs
              options={tabs}
              className="sticky top-[calc(var(--fd-nav-height)+var(--fd-tocnav-height))] z-10  border-b px-6 pt-3 xl:px-8 max-md:hidden"
            />
          )}
          {children}
        </LayoutBody>
